 ...
 * @since 1.0.0
 */
class Solume_Elementor_Tabs extends Widget_Tabs {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'tab_icon_image',
            [
                'label' => esc_html__( 'Icon/Image', 'solume' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'solume' ),
                        'icon' => 'eicon-ban',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'solume' ),
                        'icon' => 'eicon-caret-right',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'solume' ),
                        'icon' => 'eicon-image',
                    ],
                ],
                'default'   => 'none',
        ...
        $repeater->add_control(
            'ova_image',
            [
                'label'     => esc_html__( 'Choose Image', 'solume' ),
        ...
        $repeater->add_control(
            'tab_title',
            [
                'label' => esc_html__( 'Title & Description', 'solume' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Tab Title', 'solume' ),
                'placeholder' => esc_html__( 'Tab Title', 'solume' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Tab Content', 'solume' ),
                'placeholder' => esc_html__( 'Tab Content', 'solume' ),
        ...
        $this->add_control(
            'tabs',
            [
                'label' => esc_html__( 'Tabs Items', 'solume' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => esc_html__( 'Tab #1', 'solume' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'solume' ),
                    ],
                    [
                        'tab_title' => esc_html__( 'Tab #2', 'solume' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'solume' ),
                    ],
                ],
        ...
        $this->add_control(
            'type',
            [
                'label' => esc_html__( 'Position', 'solume' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'horizontal',
                'options' => [
                    'horizontal' => esc_html__( 'Horizontal', 'solume' ),
                    'vertical' => esc_html__( 'Vertical', 'solume' ),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'end' => [
                        'title' => esc_html__( 'End', 'solume' ),
                        'icon' => 'eicon-h-align-right',
                    ],
                    'stretch' => [
                        'title' => esc_html__( 'Justified', 'solume' ),
        ...
        $this->add_control(
            'navigation_width',
            [
                'label' => esc_html__( 'Navigation Width', 'solume' ),
        ...
        $this->add_control(
            'border_width',
            [
                'label' => esc_html__( 'Border Width', 'solume' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 1,
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'solume' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Color Mobile', 'solume' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'color: {{VALUE}}',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Background Mobile', 'solume' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'background-color: {{VALUE}}',
                            ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Border Color Hover', 'solume' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Border Color Active', 'solume' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (first-child)', 'solume' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (last-child)', 'solume' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
...
$widgets_manager->register(new Solume_Elementor_Tabs());