 ...
 * @since 1.0.0
 */
class Solume_Elementor_Toggle extends Widget_Toggle {
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_toggle',
			[
				'label' => esc_html__( 'Toggle', 'solume' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Title', 'solume' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Content', 'solume' ),
				'show_label' => false,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Toggle Items', 'solume' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Toggle #1', 'solume' ),
					...
					[
						'tab_title' => esc_html__( 'Toggle #2', 'solume' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'solume' ),
					],
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Icon', 'solume' ),
				'type' => Controls_Manager::ICONS,
		...
		$this->add_control(
			'title_html_tag',
			[
				'label' => esc_html__( 'Title HTML Tag', 'solume' ),
		...
		$this->add_control(
			'faq_schema',
			[
				'label' => esc_html__( 'FAQ Schema', 'solume' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector'  => '{{WRAPPER}}.elementor-widget-toggle .elementor-toggle .elementor-tab-title',
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius Active', 'solume' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_control(
				'show_before_title',
				[
					'label' 	=> esc_html__( 'Show Before Title', 'solume' ),
            ...
            $this->add_control(
                'ova_before_title',
                [
                    'label'     => esc_html__( 'Before Title Style', 'solume' ),
		...
		$this->add_control(
			'icon_hover_color',
			[
				'label' => esc_html__( 'Hover Color', 'solume' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'icon_active_color',
			[
				'label' => esc_html__( 'Active Color', 'solume' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'ova_before_icon',
			[
				'label' 	=> esc_html__( 'Before Icon', 'solume' ),
	        ...
	        $this->add_control(
				'show_boxes_icon',
				[
					'label' 	=> esc_html__( 'Show Border Icon', 'solume' ),
					'type' 		=> \Elementor\Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'solume' ),
					'label_off' => esc_html__( 'Hide', 'solume' ),
					'default' 	=> 'no',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Margin (p, h1... h6)', 'solume' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
...
$widgets_manager->register(new Solume_Elementor_Toggle());
